...
[
	...
	["drawAdvancedOnMap",          SQFM_fnc_drawAdvancedObjectiveMapData],
    ["drawMapRectangle",              SQFM_fnc_objectiveDrawMapRectangle],
	["getDebugIconAndColor",      SQFM_fnc_ObjectiveGetDebugIconAndColor],
