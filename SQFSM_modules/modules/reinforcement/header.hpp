...
displayName      = "Reinforcement Spawner";                                // Name displayed in the menu
icon             = "\a3\ui_f\data\igui\cfg\simpletasks\types\meet_ca.paa"; // Map icon. Delete this entry to use the default icon.
